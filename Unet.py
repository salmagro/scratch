...
from dataset_04 import DirDataset
...
class Unet(pl.LightningModule):
    ...
    def configure_optimizers(self):
        # return torch.optim.RMSprop(self.parameters(), lr=0.01, weight_decay=1e-8)
    ...
    def __dataloader(self):
        ...
        # dataset = DirDataset(f'/content/drive/MyDrive/ETH/train_patch/patches_500x500/{dataset}/images', 
                            #  f'/content/drive/MyDrive/ETH/train_patch/patches_500x500/{dataset}/gt')
        
        # dataset = DirDataset(f'/home/sebastian/workspace/ETH/data/{dataset}/images', 
        #                      f'/home/sebastian/workspace/ETH/data/{dataset}/gt')
